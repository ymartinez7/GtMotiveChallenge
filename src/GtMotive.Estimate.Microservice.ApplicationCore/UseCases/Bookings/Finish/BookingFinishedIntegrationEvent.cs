...
namespace GtMotive.Estimate.Microservice.ApplicationCore.UseCases.Bookings.Finish
{
    ...
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="BookingFinishedIntegrationEvent"/> class.
    /// </remarks>
    ...
    /// <param name="confirmeddOnUtc">confirmeddOnUtc.</param>
    public class BookingFinishedIntegrationEvent(
        Guid id,
        Guid userId,
        Guid vehicleId,
        DateRange duration,
        ...
        DateTime confirmeddOnUtc)
    {
        ...
        /// <summary>
        /// Gets or sets confirmeddOnUtc.
        /// </summary>
        public DateTime ConfirmeddOnUtc { get; set; } = confirmeddOnUtc;
    }
}
