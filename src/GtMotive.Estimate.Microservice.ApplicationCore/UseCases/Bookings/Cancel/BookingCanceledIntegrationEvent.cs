...
namespace GtMotive.Estimate.Microservice.ApplicationCore.UseCases.Bookings.Cancel
{
    ...
    /// </summary>
    /// <remarks>
    /// Initializes a new instance of the <see cref="BookingCanceledIntegrationEvent"/> class.
    /// </remarks>
    ...
    /// <param name="canceledOnUtc">canceledOnUtc.</param>
        ...
        DateTime canceledOnUtc)
    {
        ...
        /// <summary>
        /// Gets or sets canceledOnUtc.
        /// </summary>
        public DateTime? CanceledOnUtc { get; set; } = canceledOnUtc;
    }
}
